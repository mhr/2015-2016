 ...
 */
public class AvalancheBcnBlue extends OpMode{
    ...
    public void init()
    {
        ...
        RGBright = hardwareMap.colorSensor.get("RGBr");
        integration = 0;
        lastSuccess = 0;
    ...
    public void loop()
    {
        switch (v_state) {
            ...
            case 5: //If the first one, press, if not, move forward, and press
                //if first is red
                if(RGBright.red() > 2 && RGBright.blue() < 2 && RGBright.green() < 2) //test vals
                {
                    //press button
                    //dump climbers
                }
